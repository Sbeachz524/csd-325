...
class Todo(tk.Tk):
    def __init__(self, tasks=None):
        ...
        # REQUIRED CHANGE: Title with last name
        self.title("Beacham-ToDo")
        ...
        # REQUIRED CHANGE: Instructions label + right-click delete
        todo1 = tk.Label(
            self.tasks_frame,
            text="--- Add Items Below | Right-click to delete ---",
            bg="lightblue",
            fg="black",
            pady=10
        )
        ...
        # REQUIRED CHANGE: Complementary colors
        self.colour_schemes = [
    ...
    def add_task(self, event=None):
        ...
        if len(task_text) > 0:
            ...
            # REQUIRED CHANGE: Right-click to delete
